...
$query = 'SELECT addresses.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone
FROM addresses
	INNER JOIN customers
    ON addresses.customerID = customers.customerID
    GROUP BY addresses.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone';// PUT YOUR SQL QUERY HERE
